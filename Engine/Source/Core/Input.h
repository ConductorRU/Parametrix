...
namespace Led
{
	...
	public:
		Input();
		void SetMode(bool isRelative);
		void Close();
		bool IsKeyPressed(KEY_TYPE code);
		bool IsMousePressed(uint code);
		bool IsKeyHit(KEY_TYPE code);
		bool IsMouseHit(uint code);
		bool IsKeyReleased(KEY_TYPE code);
		bool IsMouseReleased(uint code);
		Point2 GetCursorPos();
		Point2 GetCursorRel();
